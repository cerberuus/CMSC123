...
class SibTreeNode extends TreeNode {
  ...
  public TreeNode parent() throws InvalidNodeException {
    if(isValidNode()){
      if(parent == null){
        SibTreeNode parentNew = new SibTreeNode();
        return parentNew;
      }
      else{
        return parent;
  ...
  public void insertChild(Object item, int c) throws InvalidNodeException {
    ...
    //
    if(isValidNode()){
        SibTreeNode node = new SibTreeNode(myTree, item); // creates a valid SibTreeNode
        node.parent = this;
          if(c <= 1){
          ...
          SibTreeNode node2 = (SibTreeNode)this.child(c - 1); 
            if(!node2.isValidNode()){
              node2 = this.firstChild;
