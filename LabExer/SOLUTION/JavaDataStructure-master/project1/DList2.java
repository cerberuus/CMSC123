...
public class DList2 {
   ...
   */
  public DList2(int item, int num) {
    head = new DListNode2();
    head.item = Integer.MIN_VALUE;
    head.num = Integer.MIN_VALUE;
   ...
   */
  public DList2(int itemA, int numA, int itemB, int numB) {
    head = new DListNode2();
    head.item = Integer.MIN_VALUE;
    head.num = Integer.MIN_VALUE;
    head.next = new DListNode2();
    head.next.item = itemA;
    head.next.num = numA;
    head.prev = new DListNode2();
    head.prev.item = itemB;
    head.prev.num = numB;
    head.next.prev = head;
   ...
   */
  public void insertFront(int item, int num) {
    DListNode2 one = head.next;
    head.next = new DListNode2();
    head.next.item = item;
    head.next.num = num;
    head.next.prev = head;
  ...
  public void insertBack(int item, int num) {
    DListNode2 one = head.prev;
    head.prev = new DListNode2();
    head.prev.item = item;
    head.prev.num = num;
    head.prev.prev = one;
  ...
  public String toString() {
    ...
    while (current != head) {
      result = result + current.item + ", " + current.num + "  ";
